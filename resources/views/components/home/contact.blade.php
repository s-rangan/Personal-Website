                    ...
                    >
                        ...
                        <div class = "mb-6">
                            <x-forms.input 
                                ...
                                ::class="errors.name ? 'border-rose-500 focus:border-rose-500' : ''"
                            ></x-forms.input>
                            <template x-if="errors.name">
                                <div x-text="errors.name[0]" class="text-rose-500"></div>
                            </template>
                        </div>
                        ...
                        <div class = "mb-6">
                            <x-forms.input 
                                ...
                                ::class="errors.email ? 'border-rose-500 focus:border-rose-500' : ''"
                            ></x-forms.input>
                            <template x-if="errors.email">
                                <div x-text="errors.email[0]" class="text-rose-500"></div>
                            </template>
                        </div>
                        ...
                        <div class = "mb-6">
                            <x-forms.input 
                                ...
                                ::class="errors.subject ? 'border-rose-500 focus:border-rose-500' : ''"
                            ></x-forms.input>
                            <template x-if="errors.subject">
                                <div x-text="errors.subject[0]" class="text-rose-500"></div>
                            </template>
                        </div>
                        ...
                        <div class = "mb-6">
                            <x-forms.textarea 
                                ...
                                ::class="errors.message ? 'border-rose-500 focus:border-rose-500' : ''"
                            ></x-forms.textarea>
                            <template x-if="errors.message">
                                <div x-text="errors.message[0]" class="text-rose-500"></div>
                            </template>
                        </div>
