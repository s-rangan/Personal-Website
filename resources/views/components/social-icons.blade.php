<div {{ $attributes->class(['flex items-center']) }}>
    ...
    <a
        ...
        "
    >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" width="22px" height="22px" class="fill-current">
            <path 
    ...
    <a
        ...
        "
    >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width="22px" height="22px" class="fill-current">
            <path
